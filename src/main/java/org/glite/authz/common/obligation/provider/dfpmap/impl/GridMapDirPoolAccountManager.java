...
import org.glite.authz.common.obligation.provider.dfpmap.PoolAccountManager;
...
public class GridMapDirPoolAccountManager implements PoolAccountManager {
    ...
    private String buildSubjectIdentifier(X500Principal subjectDN, String primaryGroupName,
        ...
        try{
        identifier.append(URLEncoder.encode(PKIUtils.getOpenSSLFormatPrincipal(subjectDN, true), "US-ASCII"));
